...
plt.savefig('outputs/gdp_over_time.png')
plt.show()
...
plt.savefig('outputs/average_temperature_over_time.png')
plt.show()
...
plt.savefig('outputs/total_employment_over_time.png')
plt.show()
...
plt.savefig('outputs/energy_consumption_over_time.png')
plt.show()
